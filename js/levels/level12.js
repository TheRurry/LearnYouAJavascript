...
function create() {
    ...
    //Collectable
    collectable = game.add.sprite(550, 50, 'collectable');
    ...
    newWall(100, 200, 0.05, 1.1);
    newWall(500, 380, 0.05, 0.15);
    newWall(400, 290, 0.05, 0.15);
    newWall(300, 300, 0.05, 0.5);
    newWall(200, 210, 0.05, 0.6);
    newWallh(310, 410, 1.0, 0.05);
    newWallh(510, 270, 0.5, 0.05);
    newWallh(390, 190, 0.5, 0.05);
    newWallh(390, 100, 1.0, 0.05);
    newWall(600, 200, 0.05, 1.1);
